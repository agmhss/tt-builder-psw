 ...
 * Version: The Master Build V5.0 (Strict Duty Exemptions + Combined Class Logic)
 */
...
function getIndividualClasses(classNameStr) {
    ...
    groups.forEach(group => {
        ...
        // 🌟 RULE 8: Parse Combined Classes perfectly (e.g., 6-A&B&C -> 6-A, 6-B, 6-C)
...
window.runCalculationEngine = function(renderGrid = true, forceRecalculate = false) {
    try {
        ...
        // 🌟 UPDATED: Flawless Part Time Identification based on Teacher Name OR Subjects
...
function renderExamSchedule() {
    ...
    // 🌟 RULE 10: Part-Time and HM/AHM (*) strictly exempted from EXAM duty
...
function renderSubstituteSchedule() {
    ...
    vacantSlots.forEach(slot => {
        ...
        // 🌟 RULE 10: Part-Time and HM/AHM (*) strictly exempted from SUB duty
